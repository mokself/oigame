...
import com.msr.oigame.core.date.SystemClock;
...
public class Snowflake implements Serializable {
    ...
    public Snowflake(Date epochDate, long workerId, long dataCenterId,
        ...
        Assert.isTrue(workerId >= 0 && workerId <= MAX_WORKER_ID, "workerId must between 0 and " + MAX_WORKER_ID);
        this.workerId = workerId;
        Assert.isTrue(dataCenterId >= 0 && dataCenterId <= MAX_DATA_CENTER_ID, "dataCenterId must between 0 and " + MAX_DATA_CENTER_ID);
        this.dataCenterId = dataCenterId;
        this.useSystemClock = isUseSystemClock;
        this.timeOffset = timeOffset;
        Assert.isTrue(randomSequenceLimit >= 0 && randomSequenceLimit <= SEQUENCE_MASK, "randomSequenceLimit must between 0 and " + SEQUENCE_MASK);
